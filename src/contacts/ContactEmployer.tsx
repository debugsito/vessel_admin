...
import CreateContactEmployer from './CreateContactEmployer';

const ContactEmployer = (props: any) => {
  ...
  return (
    <>
        ...
        <Table aria-label="contact employer table">
          <TableHead>
            <TableRow>
              ...
              <TableCell># Of Employer</TableCell>
      ...
      <br />
      <CreateContactEmployer contact_id={record && record.id} onCreate={refresh} />
      <br />
    </>
  );
};
